#!/bin/zsh
# v10 continuation: skip tokenizer (already trained), run steps 2-6.
set -e
...
log "Continuation run — skipping tokenizer training"
log "Using existing tokenizer: v10/checkpoints/tokenizer/best.pt"
...
run_step "03_stage1_renderer" \
    python -u v10/training/train_v10_renderer.py \
        --device mps --epochs 25 --batch-size 8 \
