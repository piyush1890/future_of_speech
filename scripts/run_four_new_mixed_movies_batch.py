...
OUT_BASE = PROJECT_ROOT / "data" / "licensed_hindi_new_mixed_batch_full_clean_guarded"
LOG_DIR = PROJECT_ROOT / "data" / "batch_logs" / "new_mixed_4_full"
...
MOVIES = [
    (
        "us_paar_1974",
        "Us Paar (1974)",
        Path("/Users/piyush/Downloads/Us Paar Hindi Full Movie HD __ Vinod Mehra, Moushumi Chatterjee __ Eagle Hindi Movies.mp4"),
    ),
    (
        "manpasand_1980",
        "Manpasand (1980)",
        Path("/Users/piyush/Downloads/Man Pasand Full Movie _ Dev Anand Hindi Movie _ Tina Munim _ Mehmood _ Bollywood Movie.mp4"),
    ),
    (
        "naseem_1995",
        "Naseem (1995)",
        Path("/Users/piyush/Downloads/Naseem 1995 Kaifi Azmi, Kay Kay Menon, Kulbhushan Kharbanda, Mayuri Kango, Salim Shah, Seema Kelkar,.mp4"),
    ),
    (
        "karwaan_2018",
        "Karwaan (2018)",
        Path("/Users/piyush/Downloads/Karwaan _Hindi Movie_Comedy-Drama _ Irrfan Khan _Mithila Palkar _English Subtitles Full Movie 2018.mp4"),
    ),
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Sequential runner for the four newer Hindi movie dialogue batch.")
